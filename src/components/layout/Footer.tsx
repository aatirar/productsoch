    ...
    <footer className="bg-dark text-white pt-16 pb-24 md:pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              <a href="https://whatsapp.com" target="_blank" rel="noopener noreferrer"
                className="text-gray-500 hover:text-primary transition-colors text-sm font-bold tracking-tight">
                WhatsApp
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a href="#" className="block text-gray-400 hover:text-white transition-colors text-sm">WhatsApp Channel</a>
            </div>
          </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-600 text-sm">© 2025 Product Soch. Free, forever.</p>
